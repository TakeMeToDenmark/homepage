...
$config['base_url'] = 'http://takemetodenmark.com'; 				// Override base URL (e.g. http://example.com)
...
// Uploads folder
$config['uploads_folder'] = 'http://takemetodenmark.com/uploads/'; 	// Can be accessed by {{ config.uploads_folder }} in a theme
